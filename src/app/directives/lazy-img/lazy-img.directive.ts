import { AfterViewInit, Directive, ElementRef, Input, Renderer2, HostListener, OnChanges, SimpleChanges } from "@angular/core";

@Directive({
  selector: "[lazyBgImage]",
})
export class LazyBgImgDirective implements AfterViewInit, OnChanges {
  hasBg = false;
  @Input() isBg = false;
  @Input() lazyBgImage = "";
  unSizeImg = ["phone"];
